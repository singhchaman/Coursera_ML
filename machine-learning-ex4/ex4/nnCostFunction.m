...
% Part 1: foward propagation
% a1 = X; 
a2 = sigmoid(Theta1 * X'); %25X5000
a2 = [ones(m,1) a2']; %add bias   5000X26
h_theta = sigmoid(Theta2 * a2'); % h_theta = g(z3)   10X5000

yk = zeros(num_labels, m); %10X5000
for i=1:m,
  yk(y(i),i)=1;
end
...
% cost function + reg_term
J = J + reg_term;

% Part 2 : Backpropagation
%first compute activations then deltas
for i=1:m,
	a1 = X(i,:); %one example at a time 1X401
	z2 = Theta1 * a1';
	a2 = sigmoid(z2); %25X1
	a2 = [1 ; a2]; % add bias
	z3 = Theta2 * a2; %10X1
